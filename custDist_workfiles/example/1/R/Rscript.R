...
setwd("C:/Users/Zuojun Gong/Desktop/Rube/rube_research/")
library(rjags)
load.module("wiener")

# Read original data from the experiment
dat <- read.table("example/1/R/data/exp1_01_m23r_2012-10-31-110958.txt", skip=8, header=T)
...
# to jags.model().
easy_model <- jags.model("example/1/easy_model.txt", dat, inits, n.chains=3)
